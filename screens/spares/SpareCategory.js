...
function SpareCategory({ navigation }) {
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.Scroll}>
        <View style={styles.flex_container}>
          <ImageBackground
            source={require("../../assets/spares/spareimg.png")}
          ...
          <View style={styles.menuItemsSection}>
            ...
            <Image
                    ...
                    source={require("../../assets/spares/comingsoon.png")}
                  />
            </View>
            </View>
            ...
            {/* <View style={styles.menuItemsFlexboxContainer}>
              ...
              <View style={styles.menuOne}>
                ...
                >
                  ...
                  <FontAwesome5 name="car-crash" size={40} color="#fff" />
